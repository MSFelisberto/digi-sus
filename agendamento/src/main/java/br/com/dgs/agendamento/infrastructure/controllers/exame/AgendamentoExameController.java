...
import br.com.dgs.agendamento.infrastructure.controllers.dto.exame.*;
...
@RestController
@RequestMapping("/exames/agendamentos")
public class AgendamentoExameController {
    ...
    public ResponseEntity<AgendaExameResponseDTO> criarAgendaExame(
        ...
        URI uri = URI.create("/agendamento/exames/agendamentos/agenda/" + response.id());
